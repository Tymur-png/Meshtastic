...
//
// Do not bind PIN_PWM_BACKLIGHT to GPIO46: on ESP32-S3 that pin is input-only
// and a strapping pin (VDD_SPI). analogWrite(46) at screen-on / brightness
// edits can reset the chip. Wire TFT LED to a real output GPIO, then define
// PIN_PWM_BACKLIGHT to that pin.
// #define PIN_PWM_BACKLIGHT <gpio>
